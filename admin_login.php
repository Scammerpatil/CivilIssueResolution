...
<body style="font-family: Dosis, sans-serif;">
    ...
    <div class="hero min-h-screen relative z-10 overflow-hidden" style="">
        <form class="w-full max-w-xl bg-base-200 px-10 py-10 rounded-lg shadow-lg my-28"
            action="./server/auth/admin_login.php" method="post">
            <div class="py-5">
            ...
            <div class="text-center">
                <span class="text-base-content text-base">Don't have an account ?</span> <a href="admin_signup.php"
                    class="text-base text-primary">Sign-Up</a>
            </div>
        </form>
    </div>
</body>
